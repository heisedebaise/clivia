...
public class ModuleCtrl {
    ...
    @Execute(name = "save", validates = {
            @Validate(validator = Validators.NOT_EMPTY, parameter = "code", failureCode = 3),
            @Validate(validator = Validators.MAX_LENGTH, number = {100}, parameter = "code", failureCode = 4),
            ...
            @Validate(validator = Validators.MAX_LENGTH, number = {100}, parameter = "executes", failureCode = 7),
            @Validate(validator = Validators.NOT_EMPTY, parameter = "columns", failureCode = 8),
            @Validate(validator = Validators.SIGN),
            @Validate(validator = ModuleService.VALIDATOR_NAME_NOT_EXISTS, parameters = {"id", "name"}, failureCode = 9)
    })
    public Object save() {
