    ...
    render = () => {
        ...
        for (let prop of meta.props(this.props.props, this.props.meta.props)) {
            ...
            if (prop.type && prop.type.startsWith('read-only')) {
                ...
                items.push(<Form.Item {...item}><DSelect service={prop.service} search={prop.search} parameter={prop.parameter} name={prop.name} value={this.state[prop.name]} vname={prop.vname} lname={prop.lname} form={this} /></Form.Item>);
